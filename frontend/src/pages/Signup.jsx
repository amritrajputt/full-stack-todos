    ...
    return (
        <div className='flex justify-center h-full align-center' >
            <div>
                ...
                <input ref={inputRef} className='rounded-lg p-2 m-2 border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500' type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder='name' /> <br />
